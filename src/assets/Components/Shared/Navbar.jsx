...
const Navbar = () => {
    return (
        <div className='shadow-sm'>
            <nav className='flex justify-between items-center px-2 py-3 container mx-auto'>
            ...
            <ul className='flex justify-between gap-4 items-center'>
                ...
                <li><NavLink to={"/dashboard"} className={({ isActive }) =>`px-4 py-2 rounded ${isActive ? "border-b-2 border-purple-500 text-purple-500" : "text-gray-700"}`}>Dashboard</NavLink></li>
            </ul>
